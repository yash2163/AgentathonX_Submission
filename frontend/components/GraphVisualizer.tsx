...
export default function GraphVisualizer({ onNodeSelected, nodeStatuses, terraformCode, overrideGraph, graphPhase }: GraphVisualizerProps) {
    ...
    const nodeTypes = useMemo(() => ({
        ...
        group: ({ data }: any) => {
            ...
            const borderColor = isVpc ? COLORS.VPC_BORDER : (isPublic ? COLORS.SUBNET_PUBLIC_BORDER : COLORS.SUBNET_PRIVATE_BORDER);
            const bgColor = isVpc ? COLORS.VPC_BG : (isPublic ? COLORS.SUBNET_PUBLIC_BG : COLORS.SUBNET_PRIVATE_BG);
